...
public class Rocket extends AppCompatImageView implements View.OnTouchListener {
    ...
    public Rocket(Context context, int color, int height, int level){
        super(context);

        mainactivity = (PopListener) context;

        setImageResource(R.mipmap.rocket);
    ...
    public void pop(boolean isTouched) {
        // notify the mainactivity that the rocket is popped
        mainactivity.popRocket(this, isTouched);
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if(!isPopped) {
            ...
            mainactivity.popRocket(this, true);
            isPopped = true;
