...
public class RocketListener implements
    ...
    public RocketListener(Rocket rocket){
        this.rocket = rocket;
    }
    ...
    public void onAnimationEnd(Animator animator) {
        ...
        if(!rocket.isPopped()) {
            rocket.pop(false); // pop balloon if reaches top of screen (finished animation)
        }
